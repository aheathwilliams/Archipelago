...
ITEM_NAME_ANNOTATIONS = {
    ...
    item_names.BANELING:       "(Zergling Morph)",
    item_names.IMPALER:        "(Hydralisk Morph)",
    item_names.LURKER:         "(Hydralisk Morph)",
    item_names.BROOD_LORD:     "(Mutalisk/Corruptor Morph)",
    item_names.VIPER:          "(Mutalisk/Corruptor Morph)",
    item_names.GUARDIAN:       "(Mutalisk/Corruptor Morph)",
    item_names.DEVOURER:       "(Mutalisk/Corruptor Morph)",
    item_names.RAVAGER:        "(Roach Morph)",
    item_names.OVERSEER:       "(Overlord Morph)",
    item_names.PRIMAL_IGNITER: "(Roach Morph)",
    item_names.TYRANNOZOR:     "(Ultralisk Morph)",
