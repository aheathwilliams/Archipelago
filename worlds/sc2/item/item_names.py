...
COMMAND_CENTER_TACTICAL_JUMP          = "Tactical Jump (Command Center)"
...
JUGGERNAUT_THRUSTERS                  = "Juggernaut Thrusters (Terran)"
SUPPLY_DEPOT_COVERT_STOCKS            = "Covert Stocks (Supply Depot)"
...
SCV_RESOURCEFUL                                    = "Resourceful (SCV)"
SCV_CAUTERIZER                                     = "Cauterizer (SCV)"
...
WARHOUND_BRAWLER_CONFIGURATION                     = "Brawler Configuration (Warhound)"
WARHOUND_JUMP_JETS                                 = "Jump Jets (Warhound)"
...
BUNKER_EMERGENCY_PROVISIONS                        = "Emergency Provisions (Bunker)"
...
IMPALER_DISTRIBUTED_ATTACK                        = "Distributed Attack (Impaler)"
IMPALER_TENTACLE_EXTENSIONS                       = "Tentacle Extensions (Impaler)"
IMPALER_DEEP_TUNNEL                               = "Deep Tunnel (Impaler)"
LURKER_SEISMIC_SPINES                             = "Seismic Spines (Lurker)"
LURKER_ADAPTED_SPINES                             = "Adapted Spines (Lurker)"
LURKER_CARAPACE                                   = "Carapace (Lurker)"
LURKER_SONAR_GLANDS                               = "Sonar Glands (Lurker)"
LURKER_PRESSURIZED_RELEASE                        = "Pressurized Release (Lurker)"
LURKER_RAPID_MORPH                                = "Rapid Morph (Lurker)"
...
HIVE_QUEEN_PSIONIC_MITOCHONDRIA                   = "Psionic Mitochondria (Hive Queen)"
HIVE_QUEEN_STRAIN_INJECTION                       = "Strain Injection (Hive Queen)"
HIVE_QUEEN_SWELLED_TRANSFUSION                    = "Swelled Transfusion (Hive Queen)"
...
SWARM_QUEEN_WILD_MUTATION                         = "Wild Mutation (Swarm Queen)"
SWARM_QUEEN_HIVE_QUEEN_INCUBATOR_CHAMBER          = "Incubator Chamber (Swarm Queen/Hive Queen)"
...
INFESTED_SCV_CAUTERIZER                           = "Cauterizer (Infested SCV)"
INFESTED_SCV_RESOURCEFUL                          = "Resourceful (Infested SCV)"
...
INFESTED_MARINE_ENDURING_STRAIN                   = "Enduring Strain (Infested Marine)"
INFESTED_MARINE_LEG_ENHANCEMENTS                  = "Leg Enhancements (Infested Marine)"
...
WISE_OLD_TORRASQUE      = "Wise Old Torrasque"
...
SPAWN_BANELINGS                  = "Spawn Banelings (Zerg)"
SPAWN_SCOURGE                    = "Spawn Scourge (Zerg)"
...
MISTWING              = "Mist Wing"
TEMPEST               = "Tempest"
MOTHERSHIP_TALDARIM   = "Tal'darim Mothership"
MOTHERSHIP_PURIFIER   = "Purifier Mothership"
...
STALKER_DISINTEGRATING_PARTICLES                        = "Disintegrating Particles (Stalker)"
STALKER_PARTICLE_REFLECTION                             = "Particle Reflection (Stalker)"
INSTIGATOR_BLINK_OVERDRIVE                              = "Blink Overdrive (Instigator)"
INSTIGATOR_RECONSTRUCTION                               = "Reconstruction (Instigator)"
INSTIGATOR_IHAN_COIL                                    = "Ihan Coil (Instigator)"
SLAYER_NYON_OVERCHARGE                                  = "Nyon Overcharge (Slayer)"
SLAYER_PHASE_ALIGNMENT                                  = "Phase Alignment (Slayer)"
...
TEMPEST_DISTRIBUTED_ATTACK                              = "Distributed Attack (Tempest)"
...
MOTHERSHIP_TALDARIM_SUMMON_DEATH_FLEET                  = "Summon Death Fleet (Tal'darim Mothership)"
MOTHERSHIP_PURIFIER_PLANET_CRACKER                      = "Planet Cracker (Purifier Mothership)"
MOTHERSHIP_AIUR_ASTRAL_RESTORATION                      = "Astral Restoration (Aiur Mothership)"
MOTHERSHIP_TALDARIM_BLOOD_FUSED_PARTICLES               = "Blood-Fused Particles (Tal'darim Mothership)"
MOTHERSHIP_TALDARIM_SHADOW_OF_DEATH                     = "Shadow of Death (Tal'darim Mothership)"
MOTHERSHIP_TALDARIM_SOUL_FORGED_CONDUITS                = "Soul-Forged Conduits (Tal'darim Mothership)"
MOTHERSHIP_PURIFIER_PURIFIED_EMBERS                     = "Purified Embers (Purifier Mothership)"
MOTHERSHIP_PURIFIER_CYBROS_SHIELDING                    = "Cybros Shielding (Purifier Mothership)"
MOTHERSHIP_PURIFIER_AMPLIFIED_POWER_REROUTER            = "Amplified Power Rerouter (Purifier Mothership)"
MOTHERSHIP_AIUR_HARMONIZED_FEEDBACK_CONDUCTORS          = "Harmonized Feedback Conductors (Aiur Mothership)"
MOTHERSHIP_AIUR_KHALAI_SHIELD_RECHARGERS                = "Khalai Shield Rechargers (Aiur Mothership)"
MOTHERSHIP_AIUR_SYMBOL_OF_UNITY                         = "Symbol Of Unity (Aiur Mothership)"
MOTHERSHIP_TIME_FIELD_MODULES                           = "Time Field Modules (Aiur/Purifier/Tal'darim Mothership)"
MOTHERSHIP_WORMHOLE_MODULES                             = "Wormhole Modules (Aiur/Purifier/Tal'darim Mothership)"
MOTHERSHIP_HANGAR_INSTALLATIONS                         = "Hangar Installations (Aiur/Purifier/Tal'darim Mothership)"
...
STALWART_SOLARITE_SCREEN                                = "Solarite Screen (Stalwart)"
...
ZEALOT_LEG_ENHANCEMENTS                                 = "Leg Enhancements (Zealot)"
ZEALOT_SHIELD_CAPACITY                                  = "Shield Capacity (Zealot)"
CENTURION_VORAZUNS_TEACHINGS                            = "Vorazun's Teachings (Centurion)"
CENTURION_QUANTUM_DODGE                                 = "Quantum Dodge (Centurion)"
SENTINEL_RESOURCE_EFFICIENCY                            = "Resource Efficiency (Sentinel)"
SENTINEL_COMBAT_RECONSTRUCTION                          = "Combat Reconstruction (Sentinel)"
SENTINEL_ADANIUM_CASING                                 = "Adanium Casing (Sentinel)"
...
TRIREME_BOMBER_MINIATURIZATION                          = "Bomber Miniaturization (Trireme)"
...
MOTHERSHIP_TALDARIM_INTEGRATED_POWER                    = "Integrated Power (Tal'darim Mothership)"
MOTHERSHIP_AIUR_VALOROUS_RESOLVE                        = "Valorous Resolve (Aiur Mothership)"
MOTHERSHIP_PURIFIER_MOBILE_POWER_FIELD                  = "Mobile Power Field (Purifier Mothership)"
...
NEXUS_KHAYDARIN_CORE                    = "Khaydarin Core (Nexus)"
NEXUS_CHRONO_EFFICIENCY                 = "Chrono Boost Efficiency (Nexus)"
ORBITAL_ASSIMILATORS                    = "Orbital Assimilators (Protoss)"
WARP_HARMONIZATION                      = "Warp Harmonization (Robotics Facility)"
WARP_HARMONIZATION_STARGATE             = "Warp Harmonization (Stargate)"
...
PYLON_PSI_ENHANCEMENT                   = "Psi Enhancement (Pylon)"
PROTOSS_BUILDING_SHIELDS                = "Augmented Shields (Protoss)"
PRODUCTION_EFFICIENCY                   = "Production Efficiency (Protoss)"
OPERATIONAL_EFFICIENCY_FLEET_BEACON     = "Operational Efficiency (Fleet Beacon)"
OPERATIONAL_EFFICIENCY_ROBOTICS_BAY     = "Operational Efficiency (Robotics Bay)"
OPERATIONAL_EFFICIENCY_TEMPLAR_ARCHIVE  = "Operational Efficiency (Templar Archive)"
OPERATIONAL_EFFICIENCY_DARK_SHRINE      = "Operational Efficiency (Dark Shrine)"
