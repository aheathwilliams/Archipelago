...
parent_present[parent_names.HAMMER_SECURITIES_CONDITION] = MercenariesNotLinkedOrItem(item_names.MARAUDER)
parent_present[parent_names.SPARTAN_COMPANY_CONDITION] = MercenariesNotLinkedOrItem(item_names.GOLIATH)
