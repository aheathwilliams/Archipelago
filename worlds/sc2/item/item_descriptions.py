...
item_descriptions = {
    ...
    item_names.WARHOUND_BRAWLER_CONFIGURATION: inspect.cleandoc("""
    ...
    item_names.WARHOUND_JUMP_JETS:inspect.cleandoc("""
        ...
        Slows nearby enemies on impact.
    """),
    ...
    item_names.HIVE_QUEEN: "Base defender and macro utility caster. Can use the Spawn Creep Tumor, Spawn Larvae, and Transfusion abilities. Moves very slowly off creep.",
    ...
    item_names.BANELING: "Anti-ground suicide unit. Does damage over a small area on death. Morphed from the Zergling.",
    ...
    item_names.SWARM_QUEEN_WILD_MUTATION: _ability_desc("Swarm Queens", "Wild Mutation", "grants a target friendly unit +100 life and double attack speed for 10 seconds"),
    item_names.SWARM_QUEEN_HIVE_QUEEN_INCUBATOR_CHAMBER: "Swarm Queens and Hive Queens may now be built two at a time from the Hatchery, Lair, or Hive.",
    ...
    item_names.IMPALER: "Allows Hydralisks to morph into Impalers.",
    item_names.LURKER: "Allows Hydralisks to morph into Lurkers.",
    ...
    item_names.BROOD_LORD: "Allows Mutalisks and Corruptors to morph into Brood Lords.",
    item_names.VIPER: "Allows Mutalisks and Corruptors to morph into Vipers.",
    ...
    item_names.OVERSEER: "Allows Overlords to morph into Overseers. Overseers can use the Spawn Creep Tumor and Contaminate abilities.",
    item_names.GUARDIAN: "Long-range anti-ground flyer. Can attack ground units. Morphed from the Mutalisk or Corruptor.",
    item_names.DEVOURER: "Anti-air flyer. Attack inflict Acid Spores. Can attack air units. Morphed from the Mutalisk or Corruptor.",
    ...
    item_names.PULSAR: "Support craft. Applies a slow to attack targets.",
    ...
    item_names.MOTHERSHIP_PURIFIER_PLANET_CRACKER: "Allows Purifier Motherships to deal massive damage in an increasing area after a brief delay. Costs resources to be able to use.",
    ...
    item_names.MOTHERSHIP_TALDARIM_BLOOD_FUSED_PARTICLES: "Taldarim Mothership's primary weapon gains massively attacked speed, but has reduced attack damage. Costs resources to research.",
    ...
    item_names.MOTHERSHIP_TALDARIM_SOUL_FORGED_CONDUITS: "Friendly units that die near Tal'darim Motherships restore health and shields to them, increased if the unit was a Tal'darim unit. Costs resources to research.",
    ...
    item_names.MOTHERSHIP_PURIFIER_CYBROS_SHIELDING: "Purifier Motherships take or provide damage reduction to units under the effects of their offensive abilities. Costs resources to research.",
    item_names.MOTHERSHIP_PURIFIER_AMPLIFIED_POWER_REROUTER: "Purifier Motherships provide attack speed to nearby friendly units, increased if they have no shields or if they're a Purifier unit. Costs resources to research.",
    item_names.MOTHERSHIP_AIUR_KHALAI_SHIELD_RECHARGERS: "Aiur Mothership's weapon will also restore shields to a nearby friendly unit when it deals damage. Costs resources to research.",
    item_names.MOTHERSHIP_AIUR_HARMONIZED_FEEDBACK_CONDUCTORS: "Aiur Mothership abilities will also cast Feedback on a nearby enemy unit. Costs resources to research.",
    item_names.MOTHERSHIP_AIUR_SYMBOL_OF_UNITY: "Aiur Motherships grant increased energy regeneration to nearby friendly units, increased for Aiur units. Costs resources to research.",
    item_names.MOTHERSHIP_TIME_FIELD_MODULES: "Allows Motherships to create a large field that manipulates the battlefield, with each Mothership having different effects. Costs resources to be able to use.",
    item_names.MOTHERSHIP_WORMHOLE_MODULES: "Allows Aiur Motherships to use Nexus Recall, Purifier Motherships to use Mass Recall, and Taldarim Motherships to use Wormhole Transit. Costs resources to be able to use.",
    item_names.MOTHERSHIP_HANGAR_INSTALLATIONS: "Allows Motherships to install a Hangar to house support drones, with each Mothership having different drones. Costs resources to research.",
    ...
    item_names.TRIREME_BOMBER_MINIATURIZATION: "Trireme War Council upgrade.\nTriremes now carry a maximum of 5 bombers, up from 3.",
